...
(2, 1, 'ESを描くうえでのコツはありますか？', '第三者に伝わることが大事だと思うので、とにかく周囲の人に見せていました。社会人、先輩、OB訪問先、など。'),
