...
public class MentorsController {
	...
	private Map<Integer, Map<String, String>> initializeMentors() {
		...
		List<Integer> ids = Arrays.asList(1, 3, 4, 6, 7, 8, 9, 10);
		List<String> names = Arrays.asList("濱崎 優希奈", "阿部野 紗弥", "九鬼 嘉隆", "田沢 尚生", "大森 萌子", "髙島 左京", "大澤 奈々子", "岡崎 仁美");
		List<String> nameEns = Arrays.asList("Yukina Hamasaki", "Saya Abeno", "Yoshitaka Kuki", "Nao Tazawa", "Moeko Omori", "Sakyo Takashima", "Nanako Osawa", "Hitomi Okazaki");
		List<String> typeNums = Arrays.asList("1", "2", "2", "2", "3", "1", "4", "4");
		List<String> types = Arrays.asList("大企業バリバリタイプ", "ベンチャー上昇志向タイプ", "ベンチャー上昇志向タイプ", "ベンチャー上昇志向タイプ", "ゆっくり人生楽しみたいタイプ", "大企業バリバリタイプ", "丁寧に教えてもらいながら仕事を楽しみたいタイプ", "丁寧に教えてもらいながら仕事を楽しみたいタイプ");
		List<String> companies = Arrays.asList("三井不動産レジデンシャル株式会社/株式会社ゴールドクレスト/株式会社肥後銀行", "株式会社Sansan", "未定", "株式会社マイクロアド", "株式会社パソナグループ/株式会社ニチイ学館", "株式会社マイナビ", "株式会社EMシステムズ", "三井不動産リアルティ株式会社/三井不動産リフォーム株式会社/JKホールディングス株式会社");
		List<String> universities = Arrays.asList("中央大学", "明治大学", "慶應義塾大学", "東北大学大学院", "立教大学", "東北学院大学", "立教大学", "立教大学");
		List<String> clubs = Arrays.asList("NAOKAN", "立教大学D-mc", "Dancing Crew JADE", "ストリートダンスサークルWHO", "立教大学D-mc", "Dance Factory's", "立教大学D-mc", "立教大学D-mc");
