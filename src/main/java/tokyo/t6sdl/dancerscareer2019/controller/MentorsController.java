...
public class MentorsController {
	...
	private List<Map<String, String>> initializeMentors() {
		...
		List<String> names = Arrays.asList("濱崎 優希奈", "牟田口 真輝", "阿部野 紗弥", "九鬼 嘉隆", "洲崎 汐音", "田沢 尚生", "大森 萌子", "髙島 左京", "大澤 奈々子");
		List<String> nameEns = Arrays.asList("Yukina Hamasaki", "Masaki Mutaguchi", "Saya Abeno", "Yoshitaka Kuki", "Shione Suzaki", "Nao Tazawa", "Moeko Omori", "Sakyo Takashima", "Nanako Osawa");
		List<String> typeNums = Arrays.asList("1", "1", "2", "2", "2", "2", "3", "4", "4");
		List<String> types = Arrays.asList("大企業バリバリタイプ", "大企業バリバリタイプ", "ベンチャー上昇志向タイプ", "ベンチャー上昇志向タイプ", "ベンチャー上昇志向タイプ", "ベンチャー上昇志向タイプ", "ゆっくり人生楽しみたいタイプ", "丁寧に教えてもらいながら仕事を楽しみたいタイプ", "丁寧に教えてもらいながら仕事を楽しみたいタイプ");
		List<String> companies = Arrays.asList("三井不動産レジデンシャル株式会社/株式会社ゴールドクレスト/株式会社肥後銀行", "未定", "株式会社Sansan", "未定", "株式会社マイクロアド", "株式会社マイクロアド", "株式会社パソナグループ/株式会社ニチイ学館", "株式会社マイナビ", "株式会社EMシステムズ");
		List<String> universities = Arrays.asList("中央大学", "横浜国立大学", "明治大学", "慶應義塾大学", "上智大学", "東北大学大学院", "立教大学", "東北学院大学", "立教大学");
		List<String> clubs = Arrays.asList("NAOKAN", "R3ude", "立教大学D-mc", "Dancing Crew JADE", "Gsplash", "ストリートダンスサークルWHO", "立教大学D-mc", "Dance Factory's", "立教大学D-mc");
